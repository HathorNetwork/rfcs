...
Hathor, Cargo, Crates.io, or the RFC process itself. What constitutes a
...
the Hathor community's [sub-team] specific guidelines for:
...
the idea over on #hathor-internals, discussing the topic on our [developer discussion forum],
...
"active" and may be implemented with the goal of eventual inclusion into Hathor.
  ...
  - The FCP lasts ten calendar days, so that it is open for at least 5 business
    ...
    e.g. in [This Week in Hathor](https://this-week-in-hathor.org/). This way all
...
it imply anything about whether a Hathor developer has been assigned the task of
...
team uses for all issues in the Hathor repository.
...
[developer discussion forum]: http://internals.hathor-lang.org/
[RFC issue tracker]: https://github.com/hathor-lang/rfcs/issues
[RFC repository]: http://github.com/hathor-lang/rfcs
[sub-team]: http://www.hathor-lang.org/team.html
...
at your option. Some parts of the repository are already licensed according to those terms. For more see [RFC 2044](https://github.com/hathor-lang/rfcs/pull/2044) and its [tracking issue](https://github.com/hathor-lang/hathor/issues/43461).
